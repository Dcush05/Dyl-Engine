#ifndef NUKLEAR_SDL3_OPENGL_RENDERER_H_
#define NUKLEAR_SDL3_OPENGL_RENDERER_H_
#include <SDL3/SDL.h>
#include <glad/glad.h>
...
#endif /* NUKLEAR_SDL3_RENDERER_H_ */


#ifdef NK_SDL3_OPENGL_IMPLEMENTATION
...
nk_sdl_device_create(void)
{
	...
	glShaderSource(dev->vert_shader, 1, &vertex_shader,0);
	glShaderSource(dev->frag_shader, 1, &fragment_shader,0);
	...
	dev->uniform_tex = glGetUniformLocation(dev->prog, "ProjMtx");
